...
/* Je remplis ma base de donnée avec des données de tests et vu que je vais créer un script que
je pourrais appeler pour remplir instantanément la base avec des dixaines de contenus.*/

//Je commence par complètement vider la base de donnée :
