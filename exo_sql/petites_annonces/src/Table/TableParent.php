...
abstract class TableParent{
    ...
    {
        // ATTENTION : il faut toujours controler les clefs du tableau et ne jamais faire confiance à ce qui vient l'utilisateur (possibilité d'injections dans les clefs dynamiquent).
        $sqlFields = [];
